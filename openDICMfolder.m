...
function [IM, INFO] = openDICMfolder(InFolder,PatientID_in)
...
% Checking to see of the PatientID has been supplied by the user
if exist('PatientID_in','var') % Used if the new Patient ID is supplied as an input
    PatientID = PatientID_in;
    
else % Used if no new Patient ID is input
    PatientID = 1;
